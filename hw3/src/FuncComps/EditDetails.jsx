...
export default function EditDetails()  {
  ...
  // לעדכן פרטים חוץ ממייל, לעדכן את הלוקל סטורז, ואת הזמני
  
  // להשתמש אולי בוליו? שיציג את הפרטים הקיימים ויחשיב את זה כפרטים שיש
  // אולי לעשות שהיוזר ישתנה ואז הוא יבדוק שכל הפרטים של היוזר שוב תקינים?
